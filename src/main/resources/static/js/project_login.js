...
//'https://1ba1-183-96-143-101.ngrok-free.app'
//https://1ba1-183-96-143-101.ngrok-free.app/login/kakaoLogin
function kakaoLogin(){
    if(redirectURL != ''){
...
function naverLogin(){
    if(redirectURL != ''){
        ...
        window.location.href = "https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=1zyMGeTLflNJkh2bmICN&state=1234&redirect_uri=" + naverRedirectUrl;
    }
